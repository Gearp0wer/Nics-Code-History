...
#define DB_CPU         0x101 
#define DB_SCHEDULER   0x201
#define DB_BIOS        0x401
#define DB_DEBUGGER    0x801
#define DB_SWAP        0x102
#define DB_IO          0x202
#define DB_MEMORY      0x402
#define DB_SIGNAL      0x802
#define DB_BOOT        0x104
#define DB_FILESYSTEM  0x204
...
/*
 * once again i fucked up the commit and cant be bothered to start fresh. 
 */ 
