...
static const char *mainmenu[] = {
	...
	"[?t] Tests menu                     ",
#ifdef OPT_SYNCHPROBS
	"[sl_simple] Stoplight simple test   ",
	"[sl_random] Stoplight random test   ",
	"[sl_prio] Stoplight prio test       ",
	"[sl_custom] Stoplight extra tests   ",
#endif
...
static struct {
	...
	{ "sl_simple", stoplight_simple },
	{ "sl_random", stoplight_random },
	{ "sl_prio",   stoplight_prio   },
	{ "sl_custom", stoplight_custom },
#endif
...
menu(char *args)
{
	...
	while (1) {
#ifdef OPT_SYNCHPROBS
		/* During synchprobs assignment, print a newline after the menu message
		 * so that the autograder can tell what's going on */
